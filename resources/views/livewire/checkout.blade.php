        ...
        <div class="col">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    No. Rekening 012345-678-910 atas nama <strong> Muhammad Husein</strong>
                </div>
            </div>
        </div>
        <div class="col">
            ...
            <form wire:submit.prevent="checkout">
                ...
                <button type="submit" class="btn btn-success btn-block"><i class="fas fa-arrow-right"></i> Check Out</button>
            </form>
        </div>
    </div>
</div>
